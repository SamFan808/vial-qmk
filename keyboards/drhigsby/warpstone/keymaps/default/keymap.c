...
const uint16_t PROGMEM rprn_combo[] = {KC_COMM, KC_M, COMBO_END};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_double175(
        KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P,
        KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN,
        KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, RSFT_T(KC_DOT),
        KC_LGUI, KC_LALT, KC_LCTL, NUM, KC_SPC, KC_RGUI, FN, KC_SLSH
  ),

    [_NUM] = LAYOUT_double175(
        KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0,
        KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_MINS, KC_EQL,
        KC_ , KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_HOME, KC_END, KC_BSLS, KC_DQUO, KC_QUOT,
        xxx, xxx, xxx, xxx, xxx, xxx, KC_PGUP, KC_PGDN
  ),
     
    [_FN] = LAYOUT_double175(
