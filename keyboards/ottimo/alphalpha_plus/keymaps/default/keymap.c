...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_FUN] = LAYOUT(
		...
		KC_LALT, KC_LGUI, KC_LSFT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, QK_BOOT,
    KC_SCROLL_LOCK, KC_NO, KC_SCROLL_LOCK, KC_SCROLL_LOCK, KC_NO, KC_NO, KC_NO
    ),

  [_NUM] = LAYOUT(
		KC_1, KC_2, KC_3, KC_4, KC_5, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
		KC_6, KC_7, KC_8, KC_9, KC_0, KC_NO, KC_TRNS, KC_LSFT, CTL_SFT, KC_NO,
		CNV_DLR, CNV_PCT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_LCTL,
    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO
    ),

	[_MOS] = LAYOUT(
		RGB_TOG, KC_NO, KC_WH_U, KC_NO, RGB_HUI, RGB_HUD, KC_MS_L, KC_MS_U, RGB_MOD, RGB_RMOD,
		KC_GRV, KC_TRNS, KC_WH_D, KC_BTN1, KC_NO, KC_NO, KC_MS_R, KC_MS_D, RGB_VAI, RGB_VAD,
		KC_LCTL, KC_NO, KC_NO, KC_BTN2, KC_NO, KC_NO, KC_NO, RGB_SAI, RGB_SAD,
    KC_NO, KC_NO, KC_NO, KC_BTN3, KC_BTN3, KC_NO, KC_NO
    )
